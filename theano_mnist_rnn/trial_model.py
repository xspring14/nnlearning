...
class Gru(object):
    def __init__(self, input, input_dim, hidden_dim, output_dim, init='uniform',
                 ...
                 activation=T.tanh, mini_batch=True, params=None):
    ...
    def cross_entropy(self, y):
        if self.mini_batch:
            return T.mean(T.nnet.categorical_crossentropy(self.y_t, y))  # naive batch-normalization
        else:
