...
class Gru(object):
    ...
    def __init__(self, input_dim=28, hidden_dim=200, output_dim=10,
    ...
    def build(self, x, y, learning_rate):
        ...
        self.sgd = theano.function(inputs=[x, y, learning_rate], outputs=cost, updates=updates)
        self.predict = theano.function(inputs=[x, y], outputs=accuracy)
...
if __name__ == '__main__':
    ...
    print "build model..."
    train_model, test_model = model.build(x, y, learning_rate)